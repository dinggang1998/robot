...
/**
 * 这是一个自动微博设置工具
 * uid为用户id，修改自己微博状态时使用自己的id
 * token 为登陆用户的token(可从微博任意接口获取，自行替换)
 * cookie 为登陆用户的cookie(可从微博任意接口获取，自行替换)
 * listId 为关注列表的id
 **/
public class WeiboHelpTest {
...
//                        ".1693537780253:; PC_TOKEN=136a781155; " +
//                        "SCF=AkZoQxSmjIW6jJNMSCgd4QqudWd7siSdwucbr3BJNNP-KFK6bOA2KLDTpdjFROxXDKs9hEdadYSV76PSAMj4Ra4" +
//                        ".; SUB=_2A25J_rltDeThGeFL41MS9SfNwz6IHXVqja2lrDV8PUNbmtAGLWTikW9NfbaweFa5yDJdkhtuFfIYs0DdfrFoOk2O; " +
//                        "SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5GPa58Qr8QzZ56s0U7h9Cd5JpX5KzhUgL.FoMf1h20SK.p1hz2dJLoIEXLxKqL1-eL1hnLxKBLB." +
//                        "2LB--LxKBLBonL12BLxK-LBKBLB-2LxK-L1hML1h.t; ALF=1725693117; SSOLoginState=1694157116; WBPSESS=Dt2hbAUaXfkVprjyrA" +
//                        "ZT_GT2kJt8J0pALyQiUysgCyanYXb_mrKYmv9v5M7g__uO-WQ7aMD4px8ai5Wf_ULixio17rJM6JmgOBO-2KRaqTfj_cHLSjbxDRR6Qz64Z7kLnem9OZ0mh" +
//                        "dm20JsZkMztrxbudW54ZL_aK0R01NTD-lg16flpgFSgo2TpWGbkCYEwhS8vbgjb5P62yc_sm_zYvA=="
//        );
...
//        System.out.println("==========================这是一条分割线===============================================");
        getAllMessage(
                "5840431155",
                "86ZrOA9umOtxvqqGkHdzDapu",
                "XSRF-TOKEN=86ZrOA9umOtxvqqGkHdzDapu; _s_tentry=weibo.com; Apache=811696460495.4924.1693537780253; SINAGLOBAL=811696460495.4924.1693537780253; ULV=1693537780331:1:1:1:811696460495.4924.1693537780253:; PC_TOKEN=136a781155; SCF=AkZoQxSmjIW6jJNMSCgd4QqudWd7siSdwucbr3BJNNP-U7n7Wz4PwhUnlNvsHwZW9IwzwJhHWBiWA6MtwPOrqI4.; SUB=_2A25J_rp7DeRhGeNI6lAT9S3LwzqIHXVqjayzrDV8PUNbmtAGLXXykW9NSLbRCweVL-NZfk_umA8ov6XsjBO0ptGS; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5ZmyoRKcYPlj5kHPT1ziWS5JpX5KzhUgL.Fo-ceKzESKeN1hq2dJLoIEqLxKnL1hMLB-2LxKqL1hnL1K2LxK-LBK5L1K-LxKnL1K5LB.x.9Btt; ALF=1725693356; SSOLoginState=1694157356; WBPSESS=Dt2hbAUaXfkVprjyrAZT_GT2kJt8J0pALyQiUysgCyYfCYCUPoIFeBzQ6wIMInsXevsSsmUoCu9FRbZpz5MxbPTFpJrkLeKtsim14wEfGVSwZpqiKCk-O1BnKZ_DlkrUnwYR6sqk8y1WNYsWPc2YXUBYqbuuuKGkfVNDkPCHp2_aKXJ44VCSrkA5sx1j5N-CgWX1JKfZZVqj94qhxNMZDg=="
        );
                                ...
                                for (int s = 0; s < commentsList.size(); s++) {
                                    ...
                                    if (comment.getJSONObject("user") != null) {
                                        ...
                                        if (totalNumber != 0) {
                                            ...
                                            if (!commentsDetailList.isEmpty() && totalNumber >= 20) {
     ...
     **/
    public static JSONObject get(String url, String token, String cookie) throws IOException, Exception {
