	...
	var methods = {
		init : function(options) {
			...
			return this.each(function () {
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__select'>" +
							...
							"<select class='form_input' name='" + nameSx + "' id='" + nameSx + "' size='" + size + "' multiple='multiple' ></select>" +
						"</div>" +
						...
						"<div class='ms2side__select'>" +
							...
							"<select  class='form_input' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple' ></select>" +
						"</div>" +
						((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
					"</div>";
				...
				leftSel.dblclick(function () {
					...
					$(this).trigger('change');
					var count =rightSel.find("option:selected").length;
					$("#myform").find("#_count").text(count)
				});
				...
				rightSel.dblclick(function () {
					...
					removeFilter.click();
					var count =rightSel.children().length;
					$("#myform").find("#_count").text(count)
				});
		...
		addOption : function(options) {
			...
			return this.each(function () {
				...
				if(el.find("[value='" +oAddOption.value + "']:selected").length==0){
					el.append(strEl);
				}
				// ELEMENTS
				var allSel = el.next().children(".ms2side__select").children("select");
